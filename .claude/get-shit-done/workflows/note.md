...
- **Global scope**: `C:/Users/Hamza Tariq/.vscode/Coding/Web Dev/Hackathon-Project/MTM/MTM/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Hamza Tariq/.vscode/Coding/Web Dev/Hackathon-Project/MTM/MTM/.claude/notes/`)
...
2. Glob `C:/Users/Hamza Tariq/.vscode/Coding/Web Dev/Hackathon-Project/MTM/MTM/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Hamza Tariq/.vscode/Coding/Web Dev/Hackathon-Project/MTM/MTM/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Hamza Tariq/.vscode/Coding/Web Dev/Hackathon-Project/MTM/MTM/.claude/notes/` — works in any directory
