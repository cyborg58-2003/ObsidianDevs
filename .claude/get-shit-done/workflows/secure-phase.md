...
```
Agent(
  prompt="Read C:/Users/Hamza Tariq/.vscode/Coding/Web Dev/Hackathon-Project/MTM/MTM/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Hamza Tariq/.vscode/Coding/Web Dev/Hackathon-Project/MTM/MTM/.claude/get-shit-done/templates/SECURITY.md`
