...
The keys live in `.claude/settings.json` (project) or `C:/Users/Hamza Tariq/.vscode/Coding/Web Dev/Hackathon-Project/MTM/MTM/.claude/settings.json` (global) — **not** in `.planning/config.json`:
