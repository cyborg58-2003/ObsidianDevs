...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Smart Doctor Connect AI helps you find specialists by symptom, book online or in-person consultations, and chat with verified doctors." },
      { property: "og:title", content: "Smart Doctor Connect AI" },
      { property: "og:description", content: "AI-assisted doctor discovery, booking, and chat for patients across Pakistan." },
